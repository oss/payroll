...
$weekbegins = $_REQUEST["startdate"];
$copyweekbegins = $_REQUEST["copydate"];
...
echo "<td><form name=\"ws\" action=\"hoursform.php\" method=\"get\">";
echo "<input name=\"startdate\" value=\"" . $weekbegins . "\" type=\"hidden\" />";
echo "<input name=\"employee\" value=\"" . $username . "\" type=\"hidden\" />";
...
<html>
	...
	<body>
	<div id="backButton"><a href='admin.php?employee=<?= $_REQUEST['employee']; ?>&startdate=<?= $_REQUEST['startdate']; ?>'><img src='images/back.png' /></a></div>
		<div id="payPeriodEndDate">
			<b>Pay Period End Date:</b> <?php echo date("m-d-Y", mktime ($hour,$minute,$second,$month,$day+20,$year)) ?>
		</div>
		<div id="entry_error" style="display:none;"></div>
		<form name="hours" action="save.php" method="post">
			<input type=hidden name=startdate value="<?= $weekbegins; ?>">
			<input type=hidden name=employee value="<?= $username; ?>">
