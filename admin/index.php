...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<script type="text/javascript">
			$(function(){
				$('#entry_view_time').click(function(){
		...
		<div id="main"> 
			...
			<div id="entry_container">
				<div id="entry_add_emp">     
	         	  	<table>
						<tr><td>Add Employee</td></tr>
						<tr><td><img src="images/homer_simpson.png" /></td></tr>
					</table>
	         	   
	         	   <div style="position: relative; width: 90%; height: 100px; padding:1% 4%; overflow:hidden;" class="fakewindowcontain"></div>
				</div>
				<div id="entry_view_time">
					<table>
						<tr><td>View Time</td></tr>
						<tr><td><img src="images/cal.png" /></td></tr>
					</table>
	            </div>
            </div>
